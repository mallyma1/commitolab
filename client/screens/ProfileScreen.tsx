...
export default function ProfileScreen() {
  ...
  const currentAvatar =
    avatarPresets.find((a) => a.id === user?.avatarPreset) || avatarPresets[0];
  ...
  return (
    ...
    >
      <View style={styles.profileHeader}>
        ...
        <ThemedText
          style={[styles.memberSince, { color: theme.textSecondary }]}
        >
          Member since {formatDate(user?.createdAt)}
        </ThemedText>
        {user?.plan === "pro" ? (
          <View
            style={[styles.proBadge, { backgroundColor: EarthyColors.gold }]}
          >
      ...
      <View style={styles.statsGrid}>
        ...
        <Card style={styles.statCard}>
          <View
            style={[styles.statIcon, { backgroundColor: `${theme.accent}20` }]}
          >
                    ...
                    <View
                      style={[
                        styles.bar,
                        {
                          ...
                          backgroundColor:
                            day.count > 0 ? theme.primary : theme.border,
                        },
                      ]}
                    />
                  </View>
            ...
            {Object.entries(categoryStats).map(([category, stats]) => (
              <Card key={category} style={styles.categoryCard}>
                ...
                <View style={styles.categoryStreak}>
                  ...
                  />
                  <ThemedText
                    style={[styles.streakText, { color: theme.secondary }]}
                  >
                    {stats.streak}
                  </ThemedText>
                </View>
